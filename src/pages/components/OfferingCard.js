...
const OfferingCard = (props) => {
    return (
        <div ref={props.refFunction}>
            <div className="xl:grid grid-cols-5 lg:pt-12 px-0 lg:py-0 md:px-16 lg:px-20 invisible absolute offeringCard h-full flex items-center">
                ...
                <div className="col-span-5 xl:col-span-3 z-20 invisible offeringCopy p-4 md:p-0">
